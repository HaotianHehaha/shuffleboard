...
# 运行 Python 脚本并捕获输出
output=$(python play_shuffleboard_with_franka.py --stage_path 'franka_shuffleboard.usda' --filepath "raw_data/apriltag_poses_1743692874.json" --train_iters_planning 5)
